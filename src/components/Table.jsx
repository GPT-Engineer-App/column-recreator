  ...
  return (
    <div className="overflow-x-auto w-full max-w-none">
      ...
      <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
        <DrawerContent className={`fixed top-1/2 right-0 transform -translate-y-1/2 translate-x-full z-50 flex w-full max-w-md flex-col bg-white shadow-lg transition-transform ${isDrawerOpen ? 'translate-x-0' : 'translate-x-full'}`}>
